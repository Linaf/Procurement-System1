  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-opera" ></i> <span>OS-Proc</span></a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<c:url value='/resources/images/img.jpg' />" alt="">User Name
      ...
      <div class="right_col" role="main">
        ...
        <footer style="position:absolute; bottom:0;  width:50%; background: #F7F7F7; margin:auto">
          <div class="copyright-info" >
            <p class="pull-right">Open Source Procurment System for:  <a href="#">Prof: Rakish</a>  
            </p>
          </div>
          <div class="clearfix"></div>
        </footer>
